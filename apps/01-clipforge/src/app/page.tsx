...
import { RibbonHero } from "@/components/three/RibbonHero";
  ...
  return (
    <main className="grain min-h-screen overflow-x-hidden">
      ...
      <section className="relative min-h-[86vh]">
        <RibbonHero />
        {/* legibility scrim over the 3D */}
        <div
          className="pointer-events-none absolute inset-0 z-[1]"
          style={{
            background:
              "linear-gradient(180deg, rgba(11,15,23,0.35) 0%, rgba(11,15,23,0) 30%, rgba(11,15,23,0.75) 100%)",
          }}
        />
        <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-6 pt-24 pb-16 text-center">
          <div className="badge mb-6">AI content repurposing studio</div>
          <h1 className="text-balance font-display text-5xl font-bold leading-[1.02] sm:text-7xl">
            One upload in.
            <br />
          ...
          <div className="mt-9 flex items-center justify-center gap-3">
            <Link href={cta} className="btn btn-primary glow text-base">
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-6 py-16">
        <Stagger className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            <StaggerItem key={f.t} className="card card-lift p-6">
      ...
      {/* ---- Pricing as film strip ---- */}
      <section id="pricing" className="relative z-10 mx-auto max-w-5xl px-6 py-14">
        <Reveal>
          <h2 className="mb-8 text-center font-display text-3xl font-bold">
            Simple, upload-based pricing
          </h2>
        </Reveal>
        <Stagger className="grid gap-4 sm:grid-cols-3">
            ...
            return (
              <StaggerItem
                ...
                className={`card card-lift p-6 ${
                  id === "pro" ? "ring-2 ring-[var(--color-brand)]" : ""
                }`}
              >
                <div className="sprockets mb-4 h-2 opacity-40" />
      ...
      <footer className="relative z-10 mx-auto max-w-6xl px-6 py-10 text-center text-xs text-[var(--color-muted)]">
