...
export const IconGear = (p: IconProps) =>
  svg(
    <>
      <path d="M8.2 2.5h3.6l.45 2.05 1.5.87 1.95-.7 1.8 3.12-1.5 1.46v1.4l1.5 1.46-1.8 3.12-1.95-.7-1.5.87-.45 2.05H8.2l-.45-2.05-1.5-.87-1.95.7-1.8-3.12 1.5-1.46v-1.4L2.5 7.84l1.8-3.12 1.95.7 1.5-.87z" />
