 ...
 * generous `max` multiplies into Neon's connection ceiling. There the pool is
 * one connection with a short idle timeout; long-lived processes get a real
...
/** Close the pool — used by scripts and the interval worker on shutdown. */
