 ...
 * a short idle timeout, and a long-lived worker gets a real pool. `prepare: false`
 * is required either way — Neon's pooled endpoint is PgBouncer in transaction mode,
