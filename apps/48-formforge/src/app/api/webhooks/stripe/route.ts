 ...
 *
 * Stripe webhook endpoint for FormForge's own billing. Verify, apply,
 * ack -- thin by design; plan logic lives in lib/stripe.
 *
 * TODO:
 ...
 * - [ ] Never write PHI or patient data in this handler's logs.
 */
